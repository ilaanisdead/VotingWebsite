...
<nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container-fluid">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="ShowCourses.php">ShowCourses</a>
                </li>
                <li class="nav-item">
    ...
    if(isset($_GET['Uid'])){
        ...
        $Db_Command = $conn->prepare("DELETE FROM course WHERE id='$id'");
        $result = $Db_Command->execute();
        if($result){
            header("Location:ShowCourses.php?status=Deleted");
        }
        else{
            header("Location:ShowCourses.php?status=Error");
        }
    ...
    <?php 
        ...
        if(isset($_GET['status'])){
            ...
            if($St == 'Inserted'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Course Successfully Created
            ...
            elseif($St =='Error'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Course Not Editted/Deleted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
            elseif($St =='Deleted'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Course Deleted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
            ...
            ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Course Editted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
        ...
        // $Db_Command = "SELECT * FROM tbl_users";
        $Db_Command = $conn->prepare("SELECT * FROM course");
        ...
        ?>
            <tr>
                ...
                <td><?php echo "<a href='EditCourse.php?Uid=$id'>Edit</a>" ?></td>
