...
<nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container-fluid">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="ShowPosts.php">ShowPosts</a>
                </li>
                <li class="nav-item">
    ...
    if(isset($_GET['Uid'])){
        ...
        $Db_Command = $conn->prepare("DELETE FROM post WHERE id='$id'");
        $result = $Db_Command->execute();
        if($result){
            header("Location:ShowPosts.php?status=Deleted");
        }
        else{
            header("Location:ShowPosts.php?status=Error");
        }
    ...
    <?php 
        ...
        if(isset($_GET['status'])){
            ...
            if($St == 'Inserted'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Post Successfully Created
            ...
            elseif($St =='Error'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Post Not Editted/Deleted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
            elseif($St =='Deleted'){
                ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Post Deleted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
            ...
            ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">Post Editted
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php
            }
        ...
        // $Db_Command = "SELECT * FROM tbl_users";
        $Db_Command = $conn->prepare("SELECT * FROM post");
        ...
        <div style = "margin:15px" align="right">
            <form method="POST" action="SearchPosts.php">
        ...
        ?>
            <tr>
                ...
                <td onclick="return confirm('Are you sure you want to delete this record');"><?php echo "<a href='ShowPosts.php?Uid=$id'>Delete</a>" ?></td>
            </tr>
