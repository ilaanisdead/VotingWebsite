    ...
    <?php
        if(isset($_POST["SearchValue"])) {
            ...
            try {
                ...
                $Db_Command = $conn->prepare("SELECT * FROM prefect WHERE id LIKE '%$search%' OR FirstName LIKE
                ...
                $Db_Command_Num_of_Rows = $conn->prepare("SELECT count(*) FROM prefect WHERE id LIKE '%$search%' OR FirstName LIKE
                '%$search%' OR LastName LIKE '%$search%'
